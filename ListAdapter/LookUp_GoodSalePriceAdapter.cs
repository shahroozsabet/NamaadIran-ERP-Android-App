...
namespace NamaadDB.Adapter
{
	...
	/// TODO: Page Up/Down
	/// </summary>
	public class LookUp_GoodSalePriceAdapter : BaseAdapter<IParcelable>
	{
		public IList<IParcelable> Orig_items { get; set; }
		public IList<IParcelable> Items { get; set; }
		private LayoutInflater mInflater;

		public LookUp_GoodSalePriceAdapter(Activity context, IList<IParcelable> items)
			: base()
		{
			Orig_items = items;
			Items = items;
		...
		public override View GetView(int position, View convertView, ViewGroup parent)
		{
			...
			if (convertView == null)
			{
				...
				holder.TVLookUpCustomCost1 = convertView.FindViewById<TextView>(Resource.Id.tVLookUpCustomCost1);
				holder.TVLookUpCustomFarsiDesc = convertView.FindViewById<TextView>(Resource.Id.tVLookUpCustomFarsiDesc);
				holder.TVLookUpCustomItemCode = convertView.FindViewById<TextView>(Resource.Id.tVLookUpCustomItemCode);
				holder.TVLookUpCustomPrice = convertView.FindViewById<TextView>(Resource.Id.tVLookUpCustomPrice);
				holder.TVLookUpCustomUnit = convertView.FindViewById<TextView>(Resource.Id.tVLookUpCustomUnit);
				holder.TVLookUpCustomRowNo = convertView.FindViewById<TextView>(Resource.Id.tVLookUpCustomRowNo);
				holder.TVLookUpCustomQuantity = convertView.FindViewById<TextView>(Resource.Id.tVLookUpCustomQuantity);
