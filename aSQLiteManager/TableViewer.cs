...
namespace NamaadDB.asqlitemanager
{
	[Activity(Label = "@string/SearchForm", Theme = "@style/SearchForm")]
	public class TableViewer : ActionBaseForm, Android.Views.View.IOnClickListener
	{
		/// <summary>
		/// The tag For Debugging purpose
		/// </summary>
		private const string TAG = "NamaadDB.TableViewer";
		...
		private static NmdDBAdapter dBHelper;
 ...
 */
		...
		private Color getBackgroundColor(NamaadDB.Entity.AField.FieldType fieldType, bool light)
		{
