...
namespace NamaadDB.asqlitemanager
{
	...
	public class QueryViewer : ActionBaseForm, Android.Views.View.IOnClickListener
	{
		/// <summary>
		/// The tag For Debugging purpose
		/// </summary>
		private const string TAG = "NamaadDB.QueryViewer";
		private string _tvQ;
		private Context _cont;
		private NmdDBAdapter _db;
		//Page offset
		...
		private void fillDataTableWithArgs()
		{
			...
			try
			{
				using (_db = new NmdDBAdapter(this))
				{
